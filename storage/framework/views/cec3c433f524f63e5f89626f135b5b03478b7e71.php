...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      <li class="nav-item">
        ...
        <h3 class="m-0 text-dark">DINAS SOSIAL PROVINSI RIAU (versi 2020)</h3>
      </li>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="https://source.unsplash.com/QAB-WJcbgJk/60x60" class="img-circle elevation-2" alt="User Image">
          <!-- <img class="img-profile rounded-circle" src="https://source.unsplash.com/QAB-WJcbgJk/60x60"> -->
        </div>
        <div class="info">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo e(url('/kgb')); ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Proses Berkala</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo e(url('/kgb/riwayatcetak')); ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Output KGB</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo e(url('/kgb/future')); ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Berkala Akan Datang</p>
                </a>
              </li>
              </li>
            </ul>
        ...
        <div class="row mb-0">
          <div class="col-sm-12">
            <div class="alert alert-success" role="alert">
              <h5 class="m-0 text-white"><?php echo $__env->yieldContent('halaman'); ?></h5>
            </div>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2020~ <a href="http://dinsos.riau.go.id">Dinsos.Riau</a>.</strong>
    All rights reserved.
...
</html><?php /**PATH C:\xampp\htdocs\kerjaPraktek\resources\views/layout/main.blade.php ENDPATH**/ ?>