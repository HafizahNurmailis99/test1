...
<?php $__env->startSection('title', 'Ubah Data Pegawai'); ?>

<?php $__env->startSection('halaman', 'Ubah Data'); ?>

<?php $__env->startSection('container'); ?>
    <div class="container">
        <div class="row">
            <div class="col-12">
            <form method="post" action="/pegawai/<?php echo e($employee->id); ?>">
...
unset($__errorArgs, $__bag); ?>" id="jabatan" placeholder="Masukkan jabatan" name="jabatan" value="<?php echo e($employee->jabatan); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group col-md-6">
                    ...
                    <select id="golongan" class="custom-select form-control <?php $__errorArgs = ['golongan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="golongan">
                        <option selected disabled value="<?php echo e($employee->golongan); ?>"></option>
                        <option>I</option>
                        <option>II</option>
                        <option>III</option>
                        <option>IV</option>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control <?php $__errorArgs = ['tgl_masuk_kerja'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="tgl_masuk_kerja" name="tgl_masuk_kerja" value="<?php echo e($employee->tgl_masuk_kerja); ?>">
                    <?php $__errorArgs = ['tgl_masuk_kerja'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kerjaPraktek\resources\views/pegawai/edit.blade.php ENDPATH**/ ?>